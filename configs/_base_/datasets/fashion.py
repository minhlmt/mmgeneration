dataset_type = 'mmcls.FashionMNIST'
...
data = dict(
    ...
    workers_per_gpu=4,
    train=dict(
        type=dataset_type, data_prefix='data/fashion_mnist',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type, data_prefix='data/fashion_mnist', pipeline=test_pipeline),
    test=dict(
        type=dataset_type, data_prefix='data/fashion_mnist', pipeline=test_pipeline))
